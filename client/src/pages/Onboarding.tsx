  ...
  return (
    <>
      ...
      <div className="onboarding-container">
        ...
        {/*Progress Indicator */}
        <div className="px-6 mb-9 onboarding-wrapper">
          <div className="flex gap-2 max-w-2xl">
            {[1,2,3].map((s)=>(
              <div key={s} className={`h-1.5 flex-1 rounded-full transition-all duration-300
                ${s <= step ? "bg-emerald-500" : "bg-slate-200 dark:big-slate-800" }`}/>
            ))}
          </div>
          ...
          {step===1 &&(
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-400 text-sm">How old are you?</h2>
          ...
          {step===2 &&(
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-400 text-sm">Your measurement</h2>
              ...
              onChange={(v)=>updateField('weight',v)} placeholder="Enter your weight" min ={20} max={30} required/>

              <Input label="Height (cm) - Optional" type="number" className="max-w-2xl" value={formData.height} 
          ...
          {step===3 &&(
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-400 text-sm">What's your goal?</h2>
          ...
          <div className="flex gap-3 lg:justify-end">
            {step>1 &&(
             ...
             <Button onClick={handleNext} className="max-lg:flex-1 lg:px-10">
                <span className="flex items-center justify-center gap-2">
                  {step===totalSteps ? 'Get Statrted': 'Continue'}
